...
import { waitFor } from '@/domain/notification/application/subscribers/test/utils/wait-for'
...
describe('On Question Best Answer Chosen (E2E)', () => {
  ...
  it('should be able to send a notification when a question answer is marked as the best', async () => {
